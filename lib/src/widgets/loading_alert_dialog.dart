          ...
          child: SingleChildScrollView(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
              ...
              Center(
                child: Text(
                  widget.loadingTitle,
                  style: textos(ctn: context, fSize: widget.tipo == 1 ? 20 : 18, fontWeight: FontWeight.w500, customcolor: color050855),
                ),
              ),
              widget.showBtn
                  ? Center(
              ...
              a.isEmpty
                  ? widget.subTitle != ""
                      ? Center(
                          child: Text(
                            widget.subTitle,
                            style: textos(ctn: context, fSize: 14, customcolor: color050855),
                          ),
                        )
                      : Container()
                  : Column(
    ...
    if (tipo == 1) {
      element = Center(
        ...
        child: LoadingIndicator(
            ...
            colors: [color050855, colore83435, color050855, colore83435, color050855, colore83435, color050855, colore83435],
