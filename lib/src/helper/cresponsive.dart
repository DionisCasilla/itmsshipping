...
TextStyle textos({required BuildContext ctn, double fSize = 16, FontWeight fontWeight = FontWeight.normal, Color customcolor = Colors.white, String fontFamily = 'Poppins'}) {
