...
TextStyle textos({required BuildContext ctn, double fSize = 16, FontWeight fontWeight = FontWeight.normal, Color customcolor = color050855, String fontFamily = 'Poppins'}) {
